...
<template>
    ...
    <div class="flex w-full max-w-[1304px] items-center justify-between px-10">
      ...
      <div class="min-[1200px]:hidden">
        ...
        >
          <img
            v-if="!isMenuOpen"
            src="~/assets/common/icons/menu.svg"
            class="right-2 top-2 size-[16px]"
            alt="Open Menu"
          />
          <img
            v-if="isMenuOpen"
            src="~/assets/common/icons/close.svg"
            class="right-2 top-2 size-[32px]"
            alt="Close Menu"
          />
        </button>
        <div
          v-if="isMenuOpen"
          class="fixed right-0 top-16 z-50 flex w-full flex-col items-start justify-start border-t-[2px] bg-white p-4 shadow-lg"
          @click="isMenuOpen = !isMenuOpen"
        >
          <a class="inline-block w-full p-[12px]" href="#how-it-works"> How it works </a>
          <div class="m-2 w-full border-b-[1px]"></div>
          <a class="inline-block w-full p-[12px]" href="#features"> Features </a>
          <div class="m-2 w-full border-b-[1px]"></div>
          <a class="inline-block w-full p-[12px]" href="#reviews"> Reviews </a>
        </div>
      </div>
      <div class="hidden items-center justify-end gap-4 min-[1200px]:flex">
        <a class="p-[12px]" href="#how-it-works"> How it works </a>
        <a class="p-[12px]" href="#features"> Features </a>
        <a class="p-[12px]" href="#reviews"> Reviews </a>
        <a
          class="mx-auto flex h-10 cursor-pointer items-center justify-start gap-2.5 overflow-hidden rounded-[27px] bg-gradient-to-r from-[#007aff] to-[#9900ff] px-6 hover:translate-y-[-2px] hover:shadow-[0px_5px_12px_0px_rgba(76,151,203,0.43)] min-[1200px]:ml-0"
          :href="storeJumpUrl"
          target="_blank"
        ...
        >
          ...
          >
            {{ isEdgeBrowser ? 'Add to Edge Now' : 'Add to Chrome Now' }}
          </div>
        </a>
      </div>
    </div>
  ...
  >
    ...
    <div class="relative w-full overflow-hidden bg-gradient-to-b from-[#b1d6ff] to-white">
      ...
      <!-- Hero Content -->
      <div
        class="relative z-10 flex w-full flex-col items-center justify-start gap-2 px-[16px] pb-[60px] pt-[100px] min-[1200px]:pb-[40px] min-[1200px]:pt-[108px]"
      >
        <div
          class="flex w-full max-w-[1224px] flex-col items-center justify-start gap-[40px] min-[1200px]:flex-row min-[1200px]:gap-[60px]"
        >
          <!-- Left Content -->
          <div
            class="flex w-full max-w-[1224px] flex-col items-start justify-start gap-[20px] min-[1200px]:w-[520px] min-[1200px]:gap-[30px]"
          >
            <!-- Heading and Description -->
            <div
              class="flex w-full flex-col items-start justify-start gap-[20px] text-center min-[1200px]:text-left"
            >
              <h1 class="w-full text-center text-[42px] leading-[1] min-[1200px]:text-left">
                <span class="font-['Inter'] font-extrabold leading-[60px] text-black">
                  Your Best<br />
                </span>
                <span class="font-['Inter'] font-extrabold leading-[60px] text-[#0e6eff]">
                  AI Homework Helper<br />
                </span>
                <span class="font-['Inter'] font-extrabold leading-[60px] text-black">
                  Fast, Accurate
                </span>
              ...
              <div
                class="w-full text-center font-['Inter'] text-[18px] font-[400] leading-[1.4] tracking-[0] text-black opacity-70 min-[1200px]:text-left"
              >
            ...
            <!-- CTA Button -->
            <a
              class="mx-auto flex items-center justify-start gap-2.5 overflow-hidden rounded-[27px] bg-gradient-to-r from-[#007aff] to-[#9900ff] p-[15px] px-8 transition-[left] after:absolute after:left-[-50%] after:top-0 after:h-full after:w-[20%] after:skew-x-[-30deg] after:bg-[linear-gradient(90deg,rgba(255,255,255,0)_0%,rgba(255,255,255,0.2)_50%,rgba(255,255,255,0)_100%)] after:duration-0 hover:translate-y-[-2px] hover:shadow-[0px_11px_22px_0px_rgba(76,151,203,0.22)] hover:after:left-[150%] hover:after:transition-[left] hover:after:duration-1000 hover:after:ease-in-out min-[1200px]:ml-0"
              :href="storeJumpUrl"
              target="_blank"
            ...
            >
              ...
              <div class="font-['Inter'] text-[18px] font-medium leading-[130%] text-white">
                {{
                  isEdgeBrowser
                    ? 'Add to Edge - Boost Your Grades Today'
                    : 'Add to Chrome - Boost Your Grades Today'
                }}
              </div>
            ...
            <div class="flex w-full items-start justify-between">
              ...
              <div class="flex flex-col items-center justify-start">
                <div
                  class="text-center font-['Inter'] text-[26px] font-extrabold leading-9 text-black"
                >
                  100M
                </div>
                <div
          ...
          <!-- Hero Image -->
          <div
            class="mt-0 w-full overflow-hidden rounded-[32px] bg-transparent shadow-[0px_1px_4px_0px_rgba(78,61,67,0.12)] min-[1200px]:w-[640px]"
          >
            <video
              class="h-full w-full"
    ...
    <section
      class="all-online-platforms-bg flex w-full flex-col items-center justify-start gap-[48px] overflow-hidden pb-[150px] pt-[32px]"
    >
      <!-- Section Title -->
      <div class="flex w-full max-w-[1224px] flex-col items-center justify-center px-[16px]">
        <h2
          class="text-center font-['Inter'] text-[32px] font-[800] tracking-[-1px] text-black min-[1200px]:tracking-normal"
        >
      ...
      <div class="flex w-full flex-col items-start justify-start gap-[120px] min-[1200px]:gap-44">
        <div class="w-full">
          ...
          >
            <!-- 第一份内容 -->
            <li
              class="flex h-[76px] min-w-[200px] items-center justify-center rounded-[18px] bg-white px-[12px] py-[8px]"
            >
              <img
                class="h-[38px] opacity-50"
                src="~/assets/app/extension/image/brands/mc-graw-hill.svg"
                alt="Lhan Academy"
              />
            </li>
            <li
            ...
            >
              <img
                class="h-[23px] opacity-50"
                src="~/assets/app/extension/image/brands/aleks.webp"
                alt="Blackboard"
              />
            </li>
            <li
            ...
            >
              <img
                class="h-[26px] opacity-50"
                src="~/assets/app/extension/image/brands/cengage.webp"
            ...
            >
              <img
                class="h-[24px] opacity-50"
                src="~/assets/app/extension/image/brands/pearson.webp"
                alt="D2L"
              />
            </li>
            <li
            ...
            >
              <img
                class="h-[24px] opacity-50"
                src="~/assets/app/extension/image/brands/wileyplus.webp"
                alt="Exam Builder"
              />
            </li>
            <li
            ...
            >
              <img
                class="h-[26px] opacity-50"
                src="~/assets/app/extension/image/brands/zybooks.webp"
                alt="Canvas"
              />
            </li>
            <li
            ...
            >
              <img
                class="h-[24px] opacity-50"
                src="~/assets/app/extension/image/brands/ixl.webp"
                alt="Moodle"
              />
            </li>
            <li
            ...
            >
              <img
                class="h-[24px] opacity-50"
                src="~/assets/app/extension/image/brands/edgenuity.webp"
                alt="Schoology"
              />
            </li>
            <!-- 复制一份内容，用于无限循环滚动 -->
    ...
    <section
      class="flex w-full flex-col items-center justify-start gap-[46px] overflow-hidden px-10 pb-[90px] pt-[30px]"
    >
      <!-- Section Title -->
      <div
      ...
      >
        ...
        >
          <div
            class="flex h-[260px] w-[240px] flex-col items-center justify-center gap-[20px] rounded-[24px] bg-[#DDF7FD] py-[38px]"
          >
            <div class="">
          ...
          <div
            class="flex h-[260px] w-[240px] flex-col items-center justify-center gap-[20px] rounded-[24px] bg-[#F2E3FF] py-[38px]"
          >
            <div class="">
          ...
          <div
            class="flex h-[260px] w-[240px] flex-col items-center justify-center gap-[20px] rounded-[24px] bg-[#CFFFF0] py-[38px]"
          >
            <div class="">
          ...
          <div
            class="flex h-[260px] w-[240px] flex-col items-center justify-center gap-[20px] rounded-[24px] bg-[#FFF2C4] py-[38px]"
          >
            <div class="">
    ...
    <section
      id="how-it-works"
      class="flex w-full flex-col items-center justify-start gap-[46px] overflow-hidden px-10 py-[90px]"
    >
      <!-- Section Title -->
      <div
        class="flex w-full max-w-[1224px] flex-col items-center justify-center gap-12 min-[1200px]:gap-24"
          ...
          >
            ...
            >
              ...
              <div class="flex grow items-center justify-center">
                <a
                  class="mx-auto flex h-[55px] items-center justify-start gap-[10px] overflow-hidden rounded-[27px] bg-gradient-to-r from-[#007aff] to-[#9900ff] px-[24px]"
                  :href="storeJumpUrl"
                  target="_blank"
            ...
            >
              ...
              <div class="flex grow flex-wrap items-center justify-center p-[18px] pb-[20px]">
                ...
                <div class="h-[50%] w-[50%] pl-[4px]">
                  <div class="relative">
                    <a
                      class="mx-auto flex h-[40px] cursor-pointer items-center justify-center overflow-hidden rounded-[27px] bg-gradient-to-r from-[#007aff] to-[#A723FF]"
                      :href="storeJumpUrl"
                      target="_blank"
                      @click="handleClickChrome({ position: 'feature6' })"
                    >
                      <span
                        class="font-['Inter'] text-[14px] font-medium leading-[130%] text-white"
                      >
            ...
            <div class="flex flex-col gap-[12px]">
              ...
              >
                <p>
                  ...
                  and then click <span class="text-[#0E6EFF]">''Confirm''</span>.
                </p>
              </div>
            </div>
          </div>
                ...
                <div class="flex h-full grow flex-col justify-between">
                  <div class="relative">
                    ...
                    <div class="absolute bottom-[-8%] left-[10%]">
                      <div
                        class="flex h-[24px] w-max items-center justify-center rounded-[9px] bg-white p-[3px] shadow-[0_3px_18px_0_rgba(52,50,123,0.22)]"
                      ...
                      >
                        ...
                        >
                          <rect
                            ...
                            height="0.859794"
                            rx="0.429897"
                            transform="rotate(90 3.11816 0.962891)"
                            fill="#E6E8EA"
                          />
                          <rect
                            x="1.39868"
                            ...
                            height="0.859794"
                            rx="0.429897"
                            transform="rotate(90 1.39868 0.962891)"
                            fill="#E6E8EA"
                          />
                        </svg>
                        <img
                          ...
                          alt="Solvely Logo"
                        />
                        <div class="mx-[3px] h-[15px] border-r border-[#CCC]"></div>
                        <div
                        ...
                        >
                          ...
                          <span class="inline-flex items-center justify-center">
                            <svg
                              ...
                              fill="none"
                            >
                              <g clip-path="url(#clip0_1130_13050)">
                                <path
                                  d="M2.70679 2.52432C2.70679 2.37856 2.75001 2.23608 2.83099 2.11489C2.91197 1.99369 3.02707 1.89923 3.16173 1.84345C3.29639 1.78767 3.44457 1.77308 3.58753 1.80151C3.73049 1.82995 3.8618 1.90014 3.96487 2.00321C4.06793 2.10627 4.13812 2.23758 4.16656 2.38055C4.195 2.5235 4.1804 2.67168 4.12462 2.80635C4.06884 2.94101 3.97438 3.0561 3.85319 3.13709C3.732 3.21806 3.58951 3.26128 3.44375 3.26128V3.50694"
                                  stroke="#111111"
                                  stroke-width="0.429897"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                />
                                <path
                                  d="M3.44387 4.52007C3.37604 4.52007 3.32104 4.46508 3.32104 4.39724C3.32104 4.32941 3.37604 4.27441 3.44387 4.27441"
                                  stroke="#111111"
                                  stroke-width="0.429897"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                />
                                <path
                                  d="M3.44385 4.52007C3.51168 4.52007 3.56668 4.46508 3.56668 4.39724C3.56668 4.32941 3.51168 4.27441 3.44385 4.27441"
                                  stroke="#111111"
                                  stroke-width="0.429897"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                />
                                <path
                                  d="M6.14612 7.16511H1.47867C1.28321 7.16511 1.09576 7.08749 0.957552 6.94928C0.819346 6.81108 0.741699 6.62359 0.741699 6.42815C0.741699 6.2327 0.819346 6.04522 0.957552 5.90701C1.09576 5.76881 1.28321 5.69118 1.47867 5.69118H5.65481C5.7851 5.69118 5.91009 5.6394 6.00221 5.54728C6.09433 5.45516 6.14612 5.33018 6.14612 5.19987V1.26939C6.14612 1.13908 6.09433 1.01412 6.00221 0.921978C5.91009 0.829839 5.7851 0.778076 5.65481 0.778076H1.47867C1.28657 0.778008 1.10204 0.852949 0.964381 0.986935C0.826721 1.12092 0.746824 1.30336 0.741699 1.49539V6.4085"
                                  stroke="#111111"
                                  stroke-width="0.429897"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                              ...
                              <defs>
                                <clipPath id="clip0_1130_13050">
                                  <rect
                                    width="6.87835"
                                    height="6.87835"
                                    fill="white"
                                    transform="translate(0.00488281 0.532959)"
                                  />
                                </clipPath>
                              </defs>
                            </svg>
                          ...
                          <span class="inline-flex items-center justify-center">
                            ...
                            >
                              <path
                                d="M8.03202 2.03491H2.44336V2.60811H8.03202V2.03491ZM8.03202 5.54574H3.87635V6.11893H8.03202V5.54574ZM8.03202 7.19311H3.87635V7.76631H8.03202V7.19311ZM3.01656 3.7545H2.44336V7.76631H3.01656V3.7545Z"
                                fill="black"
                              />
                              <path
                                d="M3.87621 3.82615H8.03188V4.39935H3.87621V3.82615Z"
                                fill="black"
                              />
                            </svg>
                            Summarize
                          </span>
                          <span class="inline-flex items-center justify-center text-[#007AFF]">
                            <svg
                              class="size-[12px]"
                              xmlns="http://www.w3.org/2000/svg"
                              width="10"
                            ...
                            >
                              <path
                                d="M6.1138 4.5594C6.1138 4.67336 6.02141 4.76575 5.90745 4.76575H3.56881C3.40996 4.76575 3.31068 4.59379 3.39011 4.45622C3.42697 4.39238 3.49509 4.35305 3.56881 4.35305H5.90745C6.02141 4.35305 6.1138 4.44543 6.1138 4.5594ZM5.90745 5.45358H3.56881C3.40996 5.45359 3.31068 5.62555 3.39011 5.76312C3.42697 5.82696 3.49509 5.86628 3.56881 5.86628H5.90745C6.0663 5.86628 6.16558 5.69432 6.08616 5.55676C6.04929 5.49291 5.98117 5.45358 5.90745 5.45358ZM8.1773 4.9721C8.17522 6.83265 6.66746 8.3404 4.80691 8.34249H1.91801C1.65208 8.3425 1.43652 8.12693 1.43652 7.861V4.9721C1.43652 2.37757 4.24518 0.755991 6.49211 2.05326C7.53491 2.65532 8.1773 3.76797 8.1773 4.9721ZM7.7646 4.9721C7.7646 2.69527 5.29986 1.27225 3.32807 2.41066C2.41296 2.939 1.84922 3.91542 1.84922 4.9721V7.861C1.84922 7.89899 1.88002 7.92979 1.91801 7.92979H4.80691C6.43962 7.92789 7.76271 6.6048 7.7646 4.9721Z"
                                fill="#007AFF"
                              />
                            </svg>
                            Chat
                          ...
                          <span
                            class="h-full rounded-[6px] bg-[#007AFF] px-[12px] text-white shadow-[0_0_12px_0_rgba(0,0,0,0.12)]"
                          >
                            Solve
                          </span>
                        </div>
    ...
    >
      <div class="flex w-full max-w-[1224px] flex-col items-start justify-start gap-[46px]">
        <!-- Section Title -->
        <div class="flex w-full items-center justify-center">
          <h2 class="text-center text-[32px] tracking-[-1px] min-[1200px]:tracking-normal">
            <span class="font-['Inter'] font-extrabold leading-[45.6px] text-[#0e6eff]"
              >All-in-One
            </span>
            <span class="font-['Inter'] font-extrabold leading-[45.6px] text-black"
        ...
        <!-- Features -->
        <div
          class="flex w-full max-w-[1224px] flex-col items-start justify-start gap-[60px] min-[1200px]:gap-[100px]"
        >
          ...
          >
            ...
            >
              <!-- Chart Image -->
              <img src="~/assets/app/extension/image/image_01_02.webp" alt="Chart" />
            </div>
            ...
            >
              ...
              <a
                class="hidden h-12 cursor-pointer items-center justify-start gap-2.5 overflow-hidden rounded-[27px] bg-gradient-to-r from-[#007aff] to-[#9900ff] px-6 min-[1200px]:flex"
                :href="storeJumpUrl"
                target="_blank"
          ...
          >
            ...
            >
              <img src="~/assets/app/extension/image/image_02_02.webp" alt="Image" />
            </div>
          </div>
          ...
          >
            ...
            >
              <img src="~/assets/app/extension/image/image_03_02.webp" alt="Image" />
            </div>
          ...
          >
            ...
            >
              <img src="~/assets/app/extension/image/image_04_02.webp" alt="Image" />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="flex w-full max-w-[1224px] items-center justify-center gap-1">
          ...
          <div class="flex flex-col items-center justify-center gap-2">
            ...
            <h2
              class="whitespace-nowrap text-center font-['Inter'] text-[32px] font-extrabold leading-tight sm:text-[38px] sm:leading-[45.60px]"
            >
              ...
              <div class="flex items-center justify-start gap-2 self-stretch">
                <div class="relative h-[50px] w-[50px] overflow-hidden rounded-full bg-white">
                  <img
                    ...
                    src="~/assets/app/extension/image/avatar_03_02.webp"
                    alt="User"
                  />
                </div>
