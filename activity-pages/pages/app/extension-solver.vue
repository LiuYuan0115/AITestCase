  ...
  >
    ...
    >
      ...
      <div class="flex w-full max-w-[1224px] flex-col items-center justify-center">
        <h2
          class="text-center font-['Inter'] text-[40px] font-[800] tracking-[-1px] text-black md:tracking-normal"
        >
      ...
      <!-- Features -->
      <div class="flex w-full flex-col items-start justify-start gap-[120px] md:gap-44">
        <div class="w-full">
          <ul
