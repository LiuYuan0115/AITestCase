...
import EdgeIcon from '~/assets/app/extension/image/edge-logo.svg'
...
<template>
  ...
  >
    ...
    <div
      class="relative w-full overflow-hidden bg-[url(~/assets/app/extension/image/hero-section-bg.webp)] bg-[size:100%_100vh] bg-top bg-no-repeat"
    >
      <!-- Hero Content -->
      <div
        class="relative z-10 flex w-full flex-col items-center justify-start gap-2 px-10 pb-[60px] pt-[100px] min-[1200px]:pb-[100px] min-[1200px]:pt-[120px]"
      >
        <div class="flex w-full max-w-[1224px] flex-col items-center justify-start">
          <div
            class="flex text-center font-['Inter'] text-[16px] font-[500] leading-[26px] text-black"
          >
            <span>
              <span class="mr-[8px]">
                <span
                  class="ml-[4px] inline-block size-[14px] bg-[url(~/assets/app/extension/image/single-star.svg)]"
                ></span>
                <span
                  class="ml-[4px] inline-block size-[14px] bg-[url(~/assets/app/extension/image/single-star.svg)]"
                ></span>
              ...
              <span class="opacity-70">4.9/5</span>
            </span>
            <span class="ml-[10px] inline-flex items-center justify-center">
              <a
                v-if="!isEdgeBrowser"
                class="inline-block size-[18px] bg-[url(~/assets/app/extension/image/chrome-store.svg)]"
                :href="storeJumpUrl"
                target="_blank"
                @click="handleClickChrome({ position: 'hero-rating' })"
              ></a>
              <a
                v-else
                class="inline-block size-[14px] bg-[url(~/assets/app/extension/image/microsoft-logo.svg)]"
                :href="storeJumpUrl"
                target="_blank"
                @click="handleClickChrome({ position: 'hero-rating' })"
              ></a>
              <span class="ml-[4px] opacity-70">
                {{ isEdgeBrowser ? 'Edge Rating' : 'Chrome Rating' }}
              </span>
            </span>
          </div>
          <!-- Hero Main Content -->
          <div
            class="mt-[28px] flex w-full max-w-[1224px] flex-col items-start justify-start gap-[40px] text-center"
          >
            <!-- Heading and Description -->
            <div
              class="flex w-full flex-col items-start justify-start gap-[12px] text-center min-[1200px]:text-left"
            >
              <h1
                class="w-full text-center font-['Inter'] text-[68px] font-[700] leading-[76px] tracking-[-3px] min-[1200px]:text-[86px] min-[1200px]:leading-[96px]"
              >
                <span class="text-[#007AFF]">Instant, Expert<br /></span>
                <span class="text-[#1F1F1F]">AI Homework Helper</span>
              </h1>
              <div
                class="w-full text-center font-['Inter'] text-[20px] font-[400] leading-[32px] tracking-[0] text-black opacity-70"
              >
                The simplest way to take a screenshot and get step-by-step<br />
                solutions for any questions,without switching tabs.
              </div>
            </div>

            <!-- Stats -->
            <div class="m-auto flex w-[520px] items-start justify-between">
              <!-- Problems Solved Stat -->
              <div class="flex flex-col items-center justify-start">
                <div
                  class="text-center font-['Inter'] text-[40px] font-[700] leading-[1.2] text-[#007AFF]"
                >
                  100M+
                </div>
                <div
                  class="text-center font-['Inter'] text-[16px] font-[500] leading-[1.2] text-[#1F1F1F]"
                >
                  Problems Solved
                </div>
              </div>
            ...
            <div class="w-full text-center">
              ...
              <div class="mt-[12px] text-center">
                <span
                  class="font-['Inter'] text-[14px] font-[400] leading-[1.3] text-black opacity-50"
                  >Free & more accurate than ChatGPT</span
                >
              </div>
            </div>
          </div>
          ...
          <!-- Hero Image -->
          <div
            class="mt-[60px] w-[640px] max-w-full overflow-hidden rounded-[32px] bg-transparent shadow-[0px_1px_4px_0px_rgba(78,61,67,0.12)] min-[1200px]:w-[800px]"
          >
            <video
              class="h-full"
    ...
    >
      ...
      <div class="flex w-full max-w-[1224px] flex-col items-center justify-center">
        <h2
          class="text-center font-['Inter'] text-[40px] font-[700] tracking-[-1px] text-[#1F1F1F] min-[1200px]:tracking-normal"
        >
          Works on All Websites You Need
        </h2>
        <p class="text-center font-['Inter'] text-[16px] font-[500] text-[#1F1F1F] opacity-70">
      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="text-[50px] font-[800] leading-[50px] text-[#1F1F1F]">
              <p>6M+</p>
            </div>
            <div
              class="flex flex-col items-center justify-center text-[16px] font-[500] leading-[1.3] text-[#1F1F1F]"
            >
        ...
        >
          ...
          >
            ...
            <div class="flex w-full flex-col gap-[12px]">
              <div
                class="text-[24px] font-[700] leading-[1.3] text-[#1F1F1F] sm:text-[34px] min-[1200px]:text-[24px]"
              >
                <p>Step 1</p>
              </div>
              <div
                class="text-[16px] font-[400] leading-[1.4] text-[#1F1F1F] sm:text-[20px] min-[1200px]:text-[16px]"
              >
                <p>
                  Click the
      ...
      >
        ...
        <div class="flex w-full items-center justify-center">
          <h2 class="text-center tracking-[-1px] min-[1200px]:tracking-normal">
            <span class="font-['Inter'] text-[40px] font-[700] leading-[45.6px] text-[#0e6eff]"
              >All-in-One
            </span>
            <span class="font-['Inter'] text-[40px] font-[700] leading-[45.6px] text-[#1F1F1F]"
        ...
        >
            ...
            >
              <div class="flex w-full flex-col items-start justify-start gap-5">
                <div class="flex w-full flex-col items-start justify-start gap-4">
                  <h3
                    class="w-full text-center font-['Inter'] text-[26px] font-bold leading-loose text-[#1F1F1F] min-[1200px]:text-left"
                  >
          ...
          >
            ...
            >
              <img src="~/assets/app/extension/image/image_03-02.webp" alt="Image" />
            </div>
          ...
          >
            ...
            >
              <img src="~/assets/app/extension/image/image_04-02.webp" alt="Image" />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="flex w-full max-w-[1224px] items-center justify-center gap-1">
          ...
          <div class="flex flex-col items-center justify-center gap-2">
            ...
            <h2
              class="whitespace-nowrap text-center font-['Inter'] text-[40px] font-[700] leading-tight sm:text-[38px] sm:leading-[45.60px]"
            >
              <span class="text-[#0e6eff]">Trusted by users</span>
              <span class="text-[#1F1F1F]"> worldwide</span>
            </h2>
          </div>
